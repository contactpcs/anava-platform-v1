...
export default function CAAlertPage() {
    ...
    <div className="space-y-6">
      ...
      {alerts.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <AlertTriangle className="w-10 h-10 text-neutral-200 mb-3" />
          <p className="text-neutral-400 text-sm">No risk alerts at this time</p>
        </div>
      )}
      ...
      <Modal isOpen={!!resolveId} onClose={() => setResolveId(null)} title="Resolve Alert">
        <textarea
          ...
          className="w-full rounded-lg border border-neutral-300 px-3 py-2 text-sm mb-4 focus:ring-2 focus:ring-primary-500 outline-none"
        />
